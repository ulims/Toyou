            ...
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  icon: const Icon(CupertinoIcons.square_list, color: Colors.indigo),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(fontSize: 14),
                  icon: const Icon(CupertinoIcons.bubble_left_bubble_right, color: Colors.indigo),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(15),
                  ),
                ),
              ...
              Row(
                children: <Widget>[
                  const Icon(CupertinoIcons.tag, color: Colors.indigo),
...
//method used to add each task created to the database
  Future _addTasks({required String taskName, required String taskDesc, required String taskTag}) async {
    ...
    //Update the create method to include the ID in each tasks
